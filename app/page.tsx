...
const suggestedQuestions = [
  ...
  "Which certificate has Suhel completed?",
...
function getVerifiedAnswer(question: string) {
  ...
  if (query.includes("study") || query.includes("education") || query.includes("university") || query.includes("major")) {
  ...
  if (query.includes("olist") || query.includes("project") || query.includes("finding")) {
  ...
  if (query.includes("excel") || query.includes("technique") || query.includes("pivot") || query.includes("chart") || query.includes("kpi")) {
  ...
  if (query.includes("skill") || query.includes("sql") || query.includes("power bi") || query.includes("python")) {
  ...
  if (query.includes("certificate") || query.includes("credential") || query.includes("coursera") || query.includes("google")) {
    return "Suhel completed the Google Data Analytics Professional Certificate through Google and Coursera on March 24, 2026. The portfolio includes view, verify, and download options.";
  }
...
function StatusBadge({ children, tone = "pending" }: { children: React.ReactNode; tone?: "known" | "pending" | "soon" }) {
  ...
  return (
    <div className="site-shell">
      ...
      <header className="site-header">
        <a className="brand" href="#home" aria-label="Sheikh Suhel Ahmed, home">
      ...
      <main id="main-content">
        <section className="hero section-wrap" id="home">
          ...
          <div className="hero-copy">
            <div className="hero-kicker"><span /> Verification-first portfolio</div>
            <h1>
              Sheikh Suhel Ahmed
              <span>Aspiring Data Analyst &amp; BBA Student</span>
            </h1>
            <p className="hero-lead">
              Developing data and business-analysis skills through structured learning and evidence-backed work at North South University.
            </p>

            <div className="hero-actions">
              <a className="button button-primary" href="#projects">View Featured Project <span aria-hidden="true">↗</span></a>
              <a className="button button-secondary" href="#ask-suhel-ai">Ask Suhel AI</a>
              <a className="button button-quiet" href="#contact">Contact</a>
            </div>

            <div className="hero-notes" aria-label="Profile snapshot">
              <div><span>Academic base</span><strong>BBA · North South University</strong></div>
              <div><span>Intended major</span><strong>Management Information Systems</strong></div>
              <div><span>Expected graduation</span><strong>2029</strong></div>
            </div>
          </div>

          <aside className="profile-panel" aria-label="Sheikh Suhel Ahmed profile">
            <div className="panel-topline">
              <span>PROFILE / VERIFIED</span>
              <StatusBadge tone="known">Approved photo</StatusBadge>
            </div>
            ...
            <div className="signal-list">
              <div><span className="signal-dot" /><span>Excel analytics evidence</span><small>Verified</small></div>
              <div><span className="signal-dot" /><span>Google Data Analytics</span><small>Certified</small></div>
              <div><span className="signal-dot" /><span>Business foundation</span><small>BBA</small></div>
            </div>
          </aside>
        </section>
        ...
        <section className="about section-wrap content-section" id="about">
          ...
          <div className="about-grid">
            <div className="about-statement">
              ...
              <p>
                I am a BBA student at North South University and an aspiring Data Analyst and Business Analyst. I am developing practical skills that connect structured data with clearer business decisions.
              </p>
            </div>
            <div className="principles-card">
              <p className="card-label">Current direction</p>
              <ul>
                <li><span>01</span> Build evidence through practical analysis</li>
                <li><span>02</span> Connect data findings to business questions</li>
                <li><span>03</span> Present work clearly for recruiter review</li>
              </ul>
              <div className="verified-summary"><StatusBadge tone="known">Current focus</StatusBadge><p>Excel, SQL, Power BI, Python, business analysis, and case competitions.</p></div>
            </div>
          </div>
        </section>
          ...
          <div className="skills-grid">
            {skills.map((skill, index) => (
              <article className="skill-card" key={skill.name}>
                ...
                <StatusBadge tone={skill.evidence === "Featured project" ? "known" : "soon"}>{skill.evidence}</StatusBadge>
              </article>
            ))}
          </div>
        </section>

        <section className="education section-wrap content-section" id="education">
          <SectionHeading
          ...
          <article className="education-card">
            <div className="education-year"><span>2029</span><small>Expected graduation</small></div>
            <div className="education-main">
              ...
              <div className="education-details education-details-approved">
                <div><span>Degree</span><strong>Bachelor of Business Administration</strong></div>
                <div><span>Intended major</span><strong>Management Information Systems</strong></div>
          ...
          <article className="featured-project">
            <div className="featured-project-copy">
              <div className="project-badges">
                <StatusBadge tone="known">Verified workbook</StatusBadge>
                <span>Excel analytics</span>
              </div>
              <p className="project-overline">Primary portfolio project</p>
              <h3>{olistCaseStudy.title}</h3>
              <p>{olistCaseStudy.subtitle}</p>
              <div className="project-techniques">
                <span>Formulas</span><span>Pivot tables</span><span>KPI summary</span><span>Charts</span>
              </div>
              <a className="button button-primary" href={`/projects/${olistCaseStudy.slug}`}>Read the Case Study <span aria-hidden="true">→</span></a>
            </div>
            <div className="project-kpi-grid" aria-label="Verified Olist project metrics">
        ...
        <section className="credentials section-wrap content-section" id="certificates">
          <SectionHeading
            eyebrow="05 / Certificate"
            title="A verified analytics credential."
            body="Visitors can view, verify, or download the approved certificate. The credential ID is not displayed on the page."
          />
          <article className="certificate-card">
            <div className="certificate-mark" aria-hidden="true">G</div>
            <div className="certificate-copy">
              <StatusBadge tone="known">Verified certificate</StatusBadge>
              <p>Google · Coursera</p>
              <h3>Google Data Analytics Professional Certificate</h3>
              <div className="certificate-meta"><span>Completed</span><strong>March 24, 2026</strong><span>Program</span><strong>9 courses</strong></div>
            </div>
            <div className="certificate-actions">
              <a className="button button-primary" href={CERTIFICATE_PATH} target="_blank" rel="noreferrer">View Certificate</a>
              <a className="button button-secondary" href={CERTIFICATE_VERIFY_URL} target="_blank" rel="noreferrer">Verify</a>
        ...
        <section className="ai-section section-wrap content-section" id="ask-suhel-ai">
          ...
          <div className="ai-grid">
            <div className="ai-context">
              <div className="ai-badge"><span>AI</span><i /></div>
              <h3>Suggested recruiter questions</h3>
              <p>Choose a verified topic or type a question. Pressing Enter submits the question.</p>
              ...
              <div className="local-note"><span>LOCAL VERIFIED MODE</span><p>Answers are limited to information visible on this website.</p></div>
            </div>

            <div className="chat-window">
              <div className="chat-header">
                <div><span className="chat-avatar">SA</span><p><strong>Ask Suhel AI</strong><small><i /> Verified-data mode</small></p></div>
                <span className="offline-label">No API connected</span>
              </div>
              <div className="chat-log" ref={chatLogRef} aria-live="polite">
                {messages.map((message, index) => (
                  <div className={`chat-message message-${message.role}`} key={`${message.role}-${index}`}>
                    {message.role === "assistant" && <span className="message-avatar">AI</span>}
                    <p>{message.text}</p>
                  </div>
                ))}
              </div>
              <form className="chat-form" onSubmit={submitQuestion}>
                <label className="sr-only" htmlFor="recruiter-question">Ask a recruiter question</label>
                <input
              ...
              <p className="chat-disclaimer">For unanswered verified questions, email Suhel at {PUBLIC_EMAIL}.</p>
            </div>
          </div>
        </section>

        <section className="contact section-wrap content-section" id="contact">
          <div className="contact-panel">
            <div className="contact-copy">
              <p className="eyebrow">07 / Contact</p>
              <h2>Start a professional conversation.</h2>
              <p>Use the approved public email or LinkedIn profile for recruiter and professional enquiries.</p>
              <StatusBadge tone="known">Public contact approved</StatusBadge>
            </div>
            <div className="contact-list">
              <a href={`mailto:${PUBLIC_EMAIL}`}><span>Email</span><strong>{PUBLIC_EMAIL}</strong></a>
              <a href={LINKEDIN_URL} target="_blank" rel="noreferrer"><span>LinkedIn</span><strong>View profile ↗</strong></a>
            </div>
          </div>
        </section>
      </main>
